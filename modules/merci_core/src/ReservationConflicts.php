...
/**
 * @file
 * Contains \Drupal\merci_core\ReservationConflicts.
...
namespace Drupal\merci_core;

use \Drupal\merci_core\ReservationConflictsInterface;
...
/*
    ...
    $dates = array(
      ...
      'value2' => $date->get('value2')->getValue()
    );
